...
class NMTVectorizer(object):
    ...
    def vectorize(self, row_dict, max_seq_length):
        ...
        target_input_indices, target_output_indices = self._get_target_indices(row_dict['target'])
        target_input_vector = self._vectorize(target_input_indices,
                                              vector_length=target_vector_length,
                                              mask_index=self.target_vocab.mask_index)
        target_output_vector = self._vectorize(target_output_indices,
                                               vector_length=target_vector_length,
                                               mask_index=self.target_vocab.mask_index)
        return {"source_vector": source_vector,
                "target_input_vector": target_input_vector,
                "target": target_output_vector,
